...
extern const char* const kDebugStringUseBoxGlyphs;
extern const char* const kDebugStringLinearMode;
extern const char* const kDebugStringOmitPipeInputScanField;
